...
data = dict(
    ...
    train=dict(
        ...
        seg_prefix='data/coco/annotations/panoptic_train2017/',
        pipeline=[
            dict(type='LoadImageFromFile', to_float32=True),
            dict(
                type='LoadPanopticAnnotations',
    ...
    val=dict(
        ...
        ins_ann_file='data/coco/annotations/instances_val2017.json'),
    test=dict(
        type='CocoPanopticDataset',
        ann_file='data/coco/annotations/panoptic_val2017.json',
        img_prefix='data/coco/val2017/',
...
evaluation = dict(
    interval=5000,
    metric=['PQ', 'bbox', 'segm'],
    dynamic_intervals=[(735001, 737500)])
...
lr_config = dict(
    ...
    warmup_iters=10)
max_iters = 737500
runner = dict(type='IterBasedRunner', max_iters=737500)
interval = 5000
dynamic_intervals = [(735001, 737500)]
